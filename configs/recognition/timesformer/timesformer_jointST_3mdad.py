...
data_root = 'data/3MDAD/RGB1'
data_root_val = 'data/3MDAD/RGB1'
data_root_test = data_root_val
ann_file_train = 'data/3MDAD/train_list.txt'
ann_file_val = 'data/3MDAD/val_list.txt'
...
load_from = "https://download.openmmlab.com/mmaction/v1.0/recognition/timesformer/timesformer_jointST_8xb8-8x32x1-15e_kinetics400-rgb/timesformer_jointST_8xb8-8x32x1-15e_kinetics400-rgb_20220815-8022d1c0.pth"
