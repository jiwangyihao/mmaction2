...
data_root = 'data/SAMDD/'
data_root_val = 'data/SAMDD/'
data_root_test = 'data/SAMDD/'
ann_file_train = 'data/SAMDD/train_list.txt'
ann_file_val = 'data/SAMDD/val_list.txt'
ann_file_test = 'data/SAMDD/val_list.txt'
